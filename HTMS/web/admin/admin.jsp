...
<html lang="en">
    ...
    <body>
        ...
        <div class="mainscreen">
            <iframe class="frames frame1 active" src="./dashboard.jsp" frameborder="0"></iframe>
            <iframe class="frames frame2" src="./roombook.jsp" frameborder="0"></iframe>
            <iframe class="frames frame3" src="./payment.jsp" frameborder="0"></iframe>
            <iframe class="frames frame4" src="./room.jsp" frameborder="0"></iframe>
            <iframe class="frames frame4" src="./staff.jsp" frameborder="0"></iframe>
        </div>
    </body>
